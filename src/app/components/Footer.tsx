                ...
                <div className="w-full flex gap-6 flex-col md:flex-row text-white">
                    ...
                    <div className="flex flex-col md:w-1/4 gap-4">
                        ...
                        <ul className="list-none flex gap-4">
                            <li>
                                <a href="https://www.facebook.com/ZoomDeutschland" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-white hover:text-zinc-300 transition-colors">
                            ...
                            <li>
                                <a href="https://www.instagram.com/ZoomDeutschland" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-white hover:text-zinc-300 transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
